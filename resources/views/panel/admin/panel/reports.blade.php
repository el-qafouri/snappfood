...
@section('content')
    ...
    <div class="container my-5">
        ...
        <div class="btn-group d-flex justify-content-center mb-4" role="group" aria-label="Basic example">
            <a href="{{ route('reports.all', ['filter' => 'today']) }}" class="btn btn-outline-primary mx-1">امروز</a>
            <a href="{{ route('reports.all', ['filter' => 'this_week']) }}" class="btn btn-outline-primary mx-1">این
                هفته</a>
            <a href="{{ route('reports.all', ['filter' => 'this_month']) }}" class="btn btn-outline-primary mx-1">این
                ماه</a>

            <a href="{{ route('reports.all', ['filter' => 'all']) }}" class="btn btn-outline-primary mx-1">همه
                سفارش‌ها</a>
        </div>
