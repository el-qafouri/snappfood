        ...
        >
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    >
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('restaurantCategory.index') }}"
                            ><i class="fas fa-home"></i>Restaurant Categories</a>
                        </li>
                        <li class="nav-item">
                            <a
                                class="nav-link active"
                                aria-current="page"
                                href="{{ route('restaurantCategory.create') }}"
                            ><i class="fas fa-plus"></i>Add Restaurant Category</a
                            >
                        </li>
                    </ul>
                </div>
