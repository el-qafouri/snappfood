...
Route::get('dashboard/seller/{id}', [UserController::class , 'dashboard'])->name('seller.dashboard');


Route::get('/seller/dashboard', [UserController::class, 'sellerIndex'])->middleware(['auth', 'role:seller'])->name('seller.dashboard');
